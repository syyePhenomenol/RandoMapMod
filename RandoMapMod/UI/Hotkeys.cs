...
{
    private readonly HashSet<string> _nonGameplayScenes =
    [
    ...
    public override void BuildLayout()
    {
        ...
        Root.ListenForHotkey(
            ...
            ModifierKeys.Ctrl,
            () => GlobalHotkeyCondition() && Conditions.TransitionRandoModeEnabled()
        );
        ...
        Root.ListenForHotkey(KeyCode.D, Debugger.LogMapPosition, ModifierKeys.Ctrl, GlobalHotkeyCondition);
    }

    private bool GlobalHotkeyCondition()
    {
        return Conditions.RandoMapModEnabled() && !_nonGameplayScenes.Contains(GameManager.instance.sceneName);
    }
