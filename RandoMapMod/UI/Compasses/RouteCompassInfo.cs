...
namespace RandoMapMod.UI
{
    public class RouteCompassInfo : CompassInfo
    {
        ...
        internal void UpdateCompassTarget()
        {
            ...
            if (RmmPathfinder.RM.CurrentRoute is Route route && route.CurrentInstruction.CompassObjectPaths is Dictionary<string, string> paths
                && paths.TryGetValue(Utils.CurrentScene(), out string goPath))
            {
